...
use App\Entity\Tva;
use App\Form\Backoffice\TvaType;
...
class TvaController extends AbstractController
{
    ...
    {
        return $this->render('backoffice/tva/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('backoffice/tva/new.html.twig', [
            'tva' => $tva,
    ...
    {
        return $this->render('backoffice/tva/show.html.twig', [
            'tva' => $tva,
        ]);
    }
    ...
    public function edit(Request $request, Tva $tva): Response
    {
        ...
        return $this->render('backoffice/tva/edit.html.twig', [
            'tva' => $tva,
            'form' => $form->createView(),
        ]);
    }
